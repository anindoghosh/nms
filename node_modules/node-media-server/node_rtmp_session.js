...
class NodeRtmpSession {
  ...
  onSocketClose() {
    Logger.log(`onSocketClose id=${this.id}`);
    this.stop();
  }

  onSocketError(e) {
    Logger.log(`onSocketError id=${this.id}`);
    this.stop();
  }

  onSocketTimeout() {
    Logger.log(`onSocketTimeout id=${this.id}`);
    this.stop();
  }
  ...
  rtmpInvokeHandler() {
    ...
    switch (invokeMessage.cmd) {
      ...
      case "FCUnpublish":
        break;
      case "deleteStream":
        this.onDeleteStream(invokeMessage,true);
        break;
      case "closeStream":
        this.onCloseStream();
        break;
  ...
  onDeleteStream(invokeMessage, shouldClose = false) {
